...
function block_category_action(){
    ...
    if( is_front_page() && $show_featured_posts ) : ?>
        <section class="mb-30 block-category pm-block-category-<?php echo $layout_style; ?>">
            <div class="container-fluid">
                <div class="row">
                    <div class="width-100 featured-post-<?php echo $layout_style; ?> featured-post-layout-<?php echo $layout_style; ?>">
...
function preferred_magazine_top_news_feeds(){
    ...
    <div class="col-md-6 col-12 top-news d-flex">
        <p class="d-inline-block mr-1 mb-0">
            <span class="top-news-title"><?php echo esc_html( get_theme_mod( 'top_news', 'Top News' ) ); ?></span>
        </p>

 ...
 * @since 1.0.0
 */
class Preferred_Magazine_Category_Post_Slider extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Category Post Slider', 'preferred-magazine' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new Preferred_Magazine_Category_Post_Slider() );
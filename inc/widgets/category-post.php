 ...
 * @since 1.0.0
 */
class Preferred_Magazine_Category_Post extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Category Post', 'preferred-magazine' );
    }
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '3' => __( 'Layout 3', 'preferred-magazine' ),
                ],
                'default' => '1',
            ]
        );
    ...
    protected function render() {
        ...
        <div class="pm-category-post pm-category-post-<?php echo $layout; ?>">
            <div class="row">
                <?php
                if ( $query->have_posts() ) :
                    ...
                    if( $layout == "1" ){
                        ...
                        $col = '<div class="col-md-4 col-sm-4 col-12 mt-30">';
                        $close_div = '</div>';

                    }elseif( $layout == "3" ){

                        $col = '<div class="col-md-12 col-sm-12 col-12 mt-30 mb-30">';
                        $close_div = '</div>';
                    ...
                    while ( $query->have_posts() ) : $query->the_post();
                        ...
                        if( $layout == "2" ) {
                            ...
                            if ( $query->current_post == 0 ) {
                                ...
                                $col = '<div class="col-md-8 col-sm-6 col-12 mt-30">';
                                $close_div = '</div>';

                            } elseif ( $query->current_post == 1 ) {

                                $col = '<div class="col-md-4 col-sm-4 col-12 mt-30 pm-category-layout-'.$layout.'">';
                                $close_div = '';
                                $align_center = ' d-flex align-items-end';
                            ...
                            if ( $query->current_post != 0 ) {
                                ...
                                $col = '<div class="col-md-12 col-sm-12 col-12 pm-category-layout-'.$layout.'">';
                                $close_div = '</div>';
                                $align_center = ' d-flex align-items-end';
                        ...
                        echo $col;
                        ?>
                        <div class="post-item<?php echo $align_center; ?>">
                            <?php if ( has_post_thumbnail() ) : ?>
                                <div class="cat-over-img position-relative mb-30">
                                    <a href="<?php echo esc_url( get_the_permalink() ); ?>">
                                        <?php the_post_thumbnail( 'preferred-magazine-lg-thumb' ); ?>
                                    </a>
                                    <?php if ( 'yes' === $settings['hide_category'] && ( ( $layout == "1" ) ) ) {  ?>
                            ...
                            <div class="block-contents">
                                <?php if ( !has_post_thumbnail() && 'yes' === $settings['hide_category']  && ( ( $layout == "1" ) ) ) {  ?>
                                    <div class="block-cats">
                                        <?php cat_bg(); ?>
                                    </div>
                                <?php }  ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Preferred_Magazine_Category_Post() );
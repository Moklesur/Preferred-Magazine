...
class Preferred_Magazine_Featured_News extends Widget_Base {
    ...
    protected function render() {
        ...
        <div class="pm-featured-news-post pm-featured-news-<?php echo $layout; ?>">
            ...
            <div class="row">
                ...
                if ( $query->have_posts() ) :
                    ...
                    while ( $query->have_posts() ) : $query->the_post();
                        ...
                        ?>
                        <div class="col-md-6 col-sm-6 col-12 mt-30">
...
Plugin::instance()->widgets_manager->register_widget_type( new Preferred_Magazine_Featured_News() );
 ...
 * @since 1.0.0
 */
class Preferred_Magazine_Product_Filter extends Widget_Base {
    ...
    public function get_title() {
        return __( 'WooCommerce Product Filter', 'preferred-magazine' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'product_category_id',
            [
                'label' => __( 'Select Product Category', 'preferred-magazine' ),
        ...
        $this->add_control(
            'limit',
            [
                'label' => __( 'Product Limit', 'preferred-magazine' ),
            ...
            <div class="category-filter-wrap mb-5 text-center">
                <div class="d-inline">
                    ...
                    foreach ( $woo_categories as $woo_cat ) {
                        ...
                        echo '<a class="text-uppercase position-relative" href="#" data-filter=".product_cat-'. $woo_cat_slug.'">'. $woo_cat_name.'</a>';
...
Plugin::instance()->widgets_manager->register_widget_type( new Preferred_Magazine_Product_Filter() );